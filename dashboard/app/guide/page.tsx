...
Strategies: EMA Trend Rider, Fibonacci RSI, Weekly Breakout.`,
  ...
  },
  {
    ...
    content: [
      ...
      {
        heading: "Auto",
        body: `Approved automatically by the bot — orders are placed immediately when a signal fires. Use only after extensive demo trading validation. Enable per mode from the Config panel.`,
      },
    ],
  },
  {
...
Stocks: Tesla, Nvidia, Google, Facebook, Netflix, AdvMicroDev`,
  ...
  },
  {
    ...
    content: [
      {
        heading: "Demo Trading",
        body: `Demo mode connects to your XM Demo account. All trades are real orders on XM's demo server — real prices, real spreads, real execution latency. Use this to validate strategies before going live.`,
      },
      {
        heading: "Live Trading",
        body: `Click Switch Account in the sidebar to choose a demo or live MT5 account. You will be prompted to confirm before reconnecting. Demo and live accounts are separated. Start live trading with reduced position sizing (e.g., 0.3% risk) for the first week.`,
      },
    ],
  },
  {
...
export default function GuidePage() {
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl w-full space-y-10">
      {/* Header */}
      <div>
