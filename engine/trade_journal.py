...
class TradeJournal:
    ...
    def log(
        ...
        *,
        ...
        original_tp2: Optional[float] = None,
        executed_sl: Optional[float] = None,
        executed_tp: Optional[float] = None,
        executed_tp2: Optional[float] = None,
        account_login: int = 0,
        account_type: str = "",
        user_id: str = "default",
        strategy: str = "",
        ...
        record = {
            ...
            "volume":       volume,
            "entry":        entry,
            # Broker-facing SL/TP used for execution/outcome display.
            "sl":           executed_sl if executed_sl is not None else sl,
            "tp":           executed_tp if executed_tp is not None else tp,
            "tp2":          executed_tp2 if executed_tp2 is not None else tp2,
            "tp3":          tp3,
            # Original strategy SL/TP before live reanchor/stop-distance adjustment.
            "original_sl":  original_sl,
            "original_tp":  original_tp,
            "original_tp2": original_tp2,
            "executed_sl":  executed_sl if executed_sl is not None else sl,
            "executed_tp":  executed_tp if executed_tp is not None else tp,
            "executed_tp2": executed_tp2 if executed_tp2 is not None else tp2,
            "profit":       profit,
